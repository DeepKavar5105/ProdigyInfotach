                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Phone 91: 9904825667</p>
                                                <p itemprop="description">Phone 91: 9106570422</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">surat,Gujrat.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">support@fos.com</p>
                                                <p itemprop="description">hello@fos.com</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
